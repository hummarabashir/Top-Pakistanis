...
class Sms_model extends CI_Model {
    ...
    function send_sms_via_clickatell($message = '' , $reciever_phone = '') {
        ...
        $clickatell_user       = "bilalkhan7086";
        //$this->db->get_where('settings', array('type' => 'clickatell_user'))->row()->description;
        $clickatell_password   ="ZEDTcWIFAIRFHc";
        // $this->db->get_where('settings', array('type' => 'clickatell_password'))->row()->description;
        $clickatell_api_id     ="3592338";
        // $this->db->get_where('settings', array('type' => 'clickatell_api_id'))->row()->description;
