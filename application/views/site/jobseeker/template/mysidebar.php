...
<div class="panel-body">
    <ul style="padding: 0px;">
      ...
      <li><a href="job_performance.php">Job Post Performance</a></li>
      <li><a href="hiringspeed.php">Hiring Speed</a></li>
      <li><a href="#">Origins</a></li>
      <li><a href="teamproductivity.php">Team Productivity</a></li>
    </ul>
  </div>
</div>
    </html>