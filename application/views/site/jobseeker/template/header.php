...
<!-- Favicon and touch icons -->
        <link rel="shortcut icon" href="<?php echo base_url() ?>vendor/ico/favicon.png">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top homenav">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll hidden-xs " href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>img/home/logoheader.png" class="img-responsive" alt="" style="margin-top: -9px;"></a>
                <!--<a class="navbar-brand page-scroll show-xs hidden-lg hidden-sm" href="index.php"><img src="img/home/logofooter.png" class="img-responsive" alt="" style="margin-top: -10px;"></a>-->
            </div>
