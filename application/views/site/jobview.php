            ...
            <div class="row">
					...
					<div class="jp_cs_com_info_wrapper">
						<div class="jp_cs_com_info_img">
							<img src="<?php echo base_url() ?>vendor/images/content/cs1.jpg" alt="job_img">
						</div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="jp_listing_left_sidebar_wrapper">
                        ...
                        <div class="jp_job_res">
                            ...
                            <ul>
                                <li><i class="fa fa-caret-right"></i>&nbsp;&nbsp; Lorem Ipsum Dolor </li>
                                <li><i class="fa fa-caret-right"></i>&nbsp;&nbsp; Lorem Ipsum Dolor </li>
                                <li><i class="fa fa-caret-right"></i>&nbsp;&nbsp; Lorem Ipsum Dolor </li>
                                <li><i class="fa fa-caret-right"></i>&nbsp;&nbsp; Lorem Ipsum Dolor </li>
                            </ul>
                            ...
                            <div class="jp_rightside_job_categories_wrapper jp_rightside_listing_single_wrapper">
                                ...
                                <div class="jp_jop_overview_img_wrapper">
                                    <div class="jp_jop_overview_img">
                                        <img src="<?php echo base_url() ?>vendor/images/content/web.png" alt="post_img" />
                                    </div>
                                </div>
