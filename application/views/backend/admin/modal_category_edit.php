	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                    <?php echo form_open(base_url() . 'index.php/admin/category/do_update/' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                        		<input type="hidden" name="cat_id" value="<?php echo $row['cat_id']; ?>">
                                <input type="hidden" name="cat_image" value="<?php echo $row['cat_image']; ?>">
                              ...
                              <div class="form-group">
                                              <div class="fileinput fileinput-new" data-provides="fileinput">
                                                  <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                                                      <img src="<?php echo base_url('uploads/category/').$row['cat_image'] ;?>" alt="...">
                                                  </div>
