               ...
               <table class="table table-bordered datatable" id="table_export">
                    <thead>
                        <tr>
                            ...
                            <th><div><?php echo get_phrase('Activate'); ?></div></th>
                   	...
                   	?>
                        ...
                        <tr>
                            ...
                            <td><a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_job_view/<?php echo $row['jobs_id']; ?>');"><i class="entypo-eye"></i></a>
             				...
             				<td><a href="javascript:;" onclick="acitvate_modal('<?php echo base_url();?>superadmin/pending_jobs/do_activate/<?php echo $row['jobs_id'].'/'.$row['user_id']; ?>');">
             				<button  class="btn btn-primary">Activate</button></a>
             				</td>
             				
             				<td><a href="javascript:;" onclick="confirm_modal('<?php echo base_url();?>superadmin/pending_jobs/do_delete/<?php echo $row['jobs_id']; ?>');"><i class="entypo-trash" style="color: #981B1B;"></i></a>
             				</td>
