<hr />
    ...
    <div class="row">
    <?php echo form_open(base_url() . 'superadmin/system_settings/do_update' , 
    ...
    <?php echo form_close();?>
      ...
      ?>
        ...
        <div class="col-md-6">
            ...
            <?php echo form_open(base_url() . 'superadmin/system_settings/upload_logo' , array(
...
<script type="text/javascript">
    $(".gallery-env").on('click', 'a', function () {
        skin = this.id;
        $.ajax({
            url: '<?php echo base_url();?>superadmin/system_settings/change_skin/'+ skin,
            success: window.location = '<?php echo base_url();?>superadmin/system_settings/'
        });
});
</script>