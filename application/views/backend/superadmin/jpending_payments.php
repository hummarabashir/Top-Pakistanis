                    ...
                    <tbody>
                   	...
                   	?>
                        ...
                        <tr>
							...
							<a href="javascript:;" onclick="acitvate_modal('<?php echo base_url();?>superadmin/jpending_payments/do_activate/<?php echo $row['jp_id']; ?>');" class="btn btn-danger btn-sm btn-icon icon-left"> <i class="entypo-brush"></i>
							Activate
							</a>
