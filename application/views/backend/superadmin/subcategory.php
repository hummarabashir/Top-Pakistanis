                   	...
                   	<?php ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['cat_name'];?></td>
             				...
             				<td><a href="javascript:;" onclick="confirm_modal('<?php echo base_url();?>superadmin/subcategory/do_delete/<?php echo $row['subcat_id']; ?>');"><i class="entypo-trash" style="color: #981B1B;"></i></a>
             				</td>
