                   ...
                   /*	echo "<pre>";
                   	...
                   	?>
                        ...
                        <tr>
							...
							<a href="javascript:;" onclick="acitvate_modal('<?php echo base_url();?>superadmin/pending_payments/do_activate/<?php echo $row['id'].'/'.$row['user_id']; ?>');" class="btn btn-danger btn-sm btn-icon icon-left"> <i class="entypo-brush"></i>
							Activate
							</a>
