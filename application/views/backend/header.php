<div class="row" style="background-color: #7ba2b6;">
	<div class="col-md-12 col-sm-12 clearfix" style="text-align:center;">
		<h2 style="font-weight:600; margin:0px;padding-top: 10px; text-transform: uppercase; color: #fff;"><?php echo $system_name;?></h2>
